...
class InvertedResidual(nn.Module):
    def __init__(self, inp, oup, stride, expand_ratio, b=1, gamma=2):
        ...
        layers.append(eca_layer(oup, b, gamma))
...
class ECA_MobileNetV2(nn.Module):
    def __init__(self, num_classes=1000, width_mult=1.0, b=1, gamma=2):
        ...
        for t, c, n, s in inverted_residual_setting:
            ...
            for i in range(n):
                ...
                features.append(block(input_channel, output_channel, stride, expand_ratio=t, b=1, gamma=2))
